...
<div style="text-align: center; margin: 1.5rem 0 2rem;">
  <a href="./overview/" rel="noopener noreferrer" style="display: inline-block; padding: 0.75rem 2rem; font-size: 1.1rem; font-weight: 600; color: #fff; background: var(--sl-color-text-accent, #3b82f6); border-radius: 8px; text-decoration: none;">
    Overview →
  </a>
</div>
